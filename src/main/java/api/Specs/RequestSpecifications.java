...
public class RequestSpecifications {
    ...
    private static RequestSpecBuilder defaultRequestSpecBuilder() {
        return new RequestSpecBuilder()
                ...
                .setBaseUri(Config.getProperties("apiBaseUrl") + Config.getProperties("apiVersion"));
    }
    ...
    public static RequestSpecification userSpec(String username, String password) {
        return defaultRequestSpecBuilder().addHeader("Authorization", getUserAuthHeader(username, password))
                .build();
    }
